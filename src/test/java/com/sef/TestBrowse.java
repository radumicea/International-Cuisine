...
public class TestBrowse {
    ...
    public void testBrowse() {
        ...
        RecipeModel testRecipe = new RecipeModel("test", "test", "test", "test", "test");
        recipeController.addRecipe(testRecipe);
        List<RecipeModel> globalRecipes = recipeController.getFromToRecipes(0, 3);
        List<RecipeModel> localRecipes = recipeController.getUserFromToRecipes(userSession.userId, 0, 3);
